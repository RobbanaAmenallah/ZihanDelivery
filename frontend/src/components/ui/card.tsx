...
>(({ className, hoverEffect = false, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      hoverEffect && 'hover:shadow-card-hover hover:border-[#1B3D87]/30 dark:hover:border-blue-500/30',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      'text-lg font-bold leading-none tracking-tight text-[#162033] dark:text-slate-100',
      className
    )}
    {...props}
  />
